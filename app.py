...
if not api_key:
    raise ValueError("❌ Google API key not found. Please add it under Tools → Secrets → GOOGLE_API_KEY")
...
with gr.Blocks() as demo:
    gr.Markdown("## 🎭 Kelly – The AI Scientist Poet Chatbot (Skeptical & Analytical)")
...
api_key = userdata.get("GOOGLE_API_KEY")
if not api_key:
    st.error("❌ Google API key not found. Please add it under Tools → Secrets → GOOGLE_API_KEY")
    st.stop()
...
st.set_page_config(page_title="Kelly: The AI Scientist Poet", page_icon="🎭", layout="centered")
st.title("🎭 Kelly: The AI Scientist Poet (Skeptical & Analytical)")
st.caption("Ask Kelly about AI, ethics, data science, or technology — and receive a poetic response.")
